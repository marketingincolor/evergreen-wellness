<?php /* Template Name: Jaimes 4-Pack */ ?>
<?php get_header('shopify'); ?>
		...
		<div class="large-8 large-offset-2 medium-10 medium-offset-1 columns">
			<div class="row">
				<div class="medium-7 columns">
					<h3>Like this Sampler? Share it with friends so they can enjoy it too!</h3>
				</div>
				<div class="medium-5 columns clearfix">
					<a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A//myevergreenwellness.com/jaimes-4-pack/"><i class="fab fa-facebook-f"></i></a>	
					<a target="_blank" href="https://twitter.com/home?status=https%3A//myevergreenwellness.com/jaimes-4-pack/"><i class="fab fa-twitter"></i></a>	
					<a target="_blank" href="https://pinterest.com/pin/create/button/?url=https%3A//https%3A//myevergreenwellness.com/jaimes-4-pack/&media=&description="><i class="fab fa-pinterest"></i></a>	
				</div>
			</div>
		</div>
	</div>
